...
#### Basic information:
- XP modes: 1.0x, 25.0x, 500.0x, 1000.0x.
...
2. Can't run:<br>
   Move the directory someplace else where there's no spaces in the path.

3. Plugins don't work:<br>
   Download the correct client version ([Link](https://gitlab.com/2009scape/rt4-client/-/jobs/7109996643/artifacts/download?file_type=archive))